...
- Foreign Qual: **15 headlines**, **4 descriptions** — state/hub prices ($930–$1000), no $885 formation claims
...
**Attorneys v5 (Sep 1 2026):** strip profession/legal-services language entirely (`attorney`, `law practice`, `filed`, `six-week`). Same commercial skeleton as other `02` RSAs (price, publication, EIN, OA, RA, Google reviews). Landing URL remains `/professions/law`. If v5 is DISAPPROVED, **pause the Attorneys ad group** and stop copy churn. v1–v4 all tripped `GOVERNMENT_DOCUMENTS_AND_OFFICIAL_SERVICES`.
