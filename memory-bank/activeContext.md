...
- **Revenue levers (website surface)** — [nypllc-revenue-levers-plan.md](../nypllc-revenue-levers-plan.md) in repo Aug 10. **Affiliate picks (Aug 12, not live):** Mercury (banking) · Gusto Impact (payroll). See [docs/affiliate-partners.md](../docs/affiliate-partners.md). Remaining site backlog: shelf SKU pages/checkouts, expedite add-on, VM checkout copy, $985 test prep (late Sep). CRM-owned RA renewal build is **PLLC-CRM**, not this repo. See [features/revenue-levers.md](features/revenue-levers.md)
...
4. **Two affiliate links** — **Mercury + Gusto Impact** (picks Aug 12; apply next) — [affiliate-partners.md](../docs/affiliate-partners.md)
...
| Revenue levers week-one slips: banking + payroll **picks made Aug 12** (Mercury · Gusto Impact); programs not applied | [affiliate-partners.md](../docs/affiliate-partners.md) |
...
Latest (Aug 12 2026): **affiliate picks** Mercury + Gusto Impact — [affiliate-partners.md](../docs/affiliate-partners.md). Earlier (Aug 4): **stop-word negative incident found + fixed**; Weekly SOP §7.1 + enabled `02_Professions_NY`. Earlier (Jul 28): First formal weekly Ads SOP. Earlier (Jul 12): §5.1 mobile UX + LCP. Earlier (Jul 11): foreign qual formula pricing + search-term mining. Earlier (Jul 9): gap fixes; launch hygiene; `01` ENABLED; conversion flip.
