...
|---|------|--------------|-------|
| **1** | **CAQH — checkout-interest 3 + backlist 20** | **PLLC-CRM** | **Done Sep 16** — 23 emails sent ($499 + hosted invoice each). 📖 [caqh-pilot-launch.md](../../PLLC-CRM/crm/docs/caqh-pilot-launch.md) |
...
| **5** | **Ads — Sep 16 hold + Sep 29–30 pre-register** | **new-york-pllc** | **Hold $105.** Sep 29–30: matured Sep 2–21 ≥0.7 conv/day and ≤$135 blended, eligible ≥4,300/wk → **$120 Oct 1**; >$150 or <0.55/day → **$90**; else hold. `03` California + Colorado groups **uploaded Sep 16**; campaign remains **PAUSED / unattached** for Sid to launch. **Bing slip-item.** **$985 February.** Gate 2 Sales exact-neg **filed, not applied**. |
...
| **Sep 15–22** | **Enable `03`** (CA + CO groups ready; Sid still controls attach + enable). **Bing slip-item.** No Sales→Discovery. Attorneys AG stays paused. |
