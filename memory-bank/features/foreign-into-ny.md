...
Source: `data/foreign-qualification-cogs.json`. Current flats: NJ $995 · PA $995 · FL $930 · TX $930 · CT $1000 · CA $905 · CO $895.

**California (Sep 16 2026):** California generally does not permit an LLC to render licensed professional services (Corporations Code §17701.04). The page leads with the foreign PC path and requires entity-specific review before describing an LLC as eligible for New York foreign PLLC authority. Standard California Certificate of Status and certified formation copy are $5 each; flat list price is **$905**.
...
**Use for future expansion** — remaining states are in the CoGS JSON; seven state pages are now built.
