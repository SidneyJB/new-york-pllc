...
- Weekly SOP (Sep 13): no account changes. 7d CPA $133 / 4.88 conv; 30d CPA $133 / 18 conv; Ads Spiffy 18 vs CRM 17 (+5.9%); self-block 0; tCPA $105 day 12; Sales ISO week 4,062; `01` 6.50 lifetime; Attorneys AG paused; Gate 1 fail / Gate 2 volume fail expected / **`03`+Bing still Sep 15–22**. Writeup: `ads-pull-2026-09-13-weekly-sop/WEEKLY-SOP.md`
...
- `03_ForeignQual_US`: US Presence · $15/day · negatives **A-FQ + B–E** · **8 AGs / 39 kws / 16 RSAs** (`campaigns/24012757620`). **Sep 16:** California + Colorado groups uploaded; campaign **ENABLED** on portfolio Target CPA **$105**. Generic + five original state groups **APPROVED** (Jul RSAs). **California + Colorado** RSAs still `UNKNOWN` pending review — enabled without gating the approved groups.
