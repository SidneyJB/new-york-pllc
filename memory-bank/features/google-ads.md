...
- First weekly SOP (Jul 28, due Jul 27): `[nys pllc formation]` exact → `01` Formation-Core; List C +`pllc name availability` +`check llc availability` (27 members). 30d CPA $96 / Ads↔CRM primary 9=9. Writeup: `ads-pull-2026-07-28-weekly-sop/WEEKLY-SOP.md` · `ads-weekly-dashboard.csv`
