...
- **Revenue levers (site):** Direct-RA live Aug 25; CAQH **Sep 16 checkout-interest 3 + backlist 20 sent with $499 hosted invoices**; **Mercury + Gusto third ping Sep 1** (links not live); Spiffy checkbox live: **S Corp $195** (sales tax **off checkout Aug 18**); remaining DBA / CAQH Spiffy SKU, VM copy; **$985 deferred to Feb** — 📖 [revenue levers plan](../nypllc-revenue-levers-plan.md) · [caqh-pilot-launch.md](../../PLLC-CRM/crm/docs/caqh-pilot-launch.md)
