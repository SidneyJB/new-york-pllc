...
- [x] Foreign-into-NY state landing pages - NJ ($975/$945), PA ($995/$995), FL ($910/$915), TX ($910/$930), CT ($995/$995) with state-specific copy, FAQs, SEO, structured data, sitemap (completed)
...
- [x] Foreign state page checklist UX - customer-only "What we need from you" section; service-obtained docs moved to "What we check before filing"; virtual address/registered agent cross-sell link (completed)
