...
Oct–Dec 2025 cohort ≈ 56 renewals landing Oct–Dec 2026 (~28 per arm). That is a **smoke detector**, not a scale: it can tell you people upgrade at all, and whether the upsell obviously spikes cancels or disputes. It cannot measure precise lift. **Mid-January is a red-flag checkpoint only** — kill the Compliance Plan block if treatment cancels or disputes are clearly worse. Keep the 50/50 running into the 2027 renewals; by March you should have 150–200 people and a real answer. Do not declare a winner on 56. Measure: upgrade rate, **cancel rate** (does the upsell email itself increase cancels? — the key risk), dispute rate, payment success, and net revenue per eligible renewal. Control stays dark (no Compliance Plan offer through their renewal). This cohort also calibrates the financial model's renewal assumptions.
