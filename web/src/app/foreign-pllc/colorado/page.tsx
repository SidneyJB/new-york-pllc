...
const content: StateForeignQualificationContent = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        `Possibly. If the Colorado legal name does not comply with New York professional naming rules, we can file a Certificate of Assumed Name. The assumed-name service is $${PRICING.assumedNamePrice}.`,
    },
    {
...
export const metadata = generateStateForeignQualMetadata({
  ...
  description:
    'Qualify your Colorado professional LLC, PLLC, or PC for New York. NYSED authority, DOS filing, 6-week publication handled end-to-end. $895 flat.',
  keywords: [
