...
const content: StateForeignQualificationContent = {
  ...
  documents: [
    'Current New Jersey entity name.',
    'New Jersey 10-digit business ID, if available.',
    'Entity type shown in the New Jersey Division of Revenue and Enterprise Services record.',
    'New Jersey Standing Certificate.',
    'Certified New Jersey Certificate of Formation, Certificate of Incorporation, charter record, and any amendments.',
    'Professional-purpose language from the New Jersey filing record, if using the foreign PLLC path.',
