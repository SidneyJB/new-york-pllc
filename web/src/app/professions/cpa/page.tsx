...
export const metadata: Metadata = {
  title: `New York CPA PLLC Formation — $${PRICING.basePrice} Flat | NYPLLC`,
  description: `CPA PLLC formation for New York accountants. NYSED pre-approval, compliant naming, precise filings, six-week publishing, EIN — flat $${PRICING.basePrice}.`,
  keywords: [
