        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateProfessionServiceSchema({
              name: 'New York LCSW PLLC Formation Service',
              description:
                'PLLC formation for New York Licensed Clinical Social Workers (LCSW) including NYSED pre-approval coordination, compliant naming, precise filing, required publication, and bank-ready documents.',
              url: '/professions/lcsw',
              offers: [
                {
                  name: 'LCSW PLLC Formation Package',
                  description:
                    'Includes NYSED pre-approval packet coordination, six-week publication, Certificate of Publication, and formation documents for your social work practice.',
                  price: `${PRICE}.00`,
                  priceCurrency: 'USD',
